...
export function ContactButton({ studentId }: ContactButtonProps) {
  ...
  return (
    <button
      ...
      disabled={sending}
      className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-blue-700 disabled:opacity-50"
    >
