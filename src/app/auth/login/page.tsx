...
function GoogleLoginButton({ callbackUrl }: { callbackUrl: string }) {
  return (
    <form action={`/api/auth/signin/google`} method="POST">
      ...
      <button
        type="submit"
        className="flex w-full items-center justify-center gap-3 rounded-md border border-border bg-surface px-4 py-3 text-sm font-medium text-fg transition-all hover:bg-primary-50"
      >
